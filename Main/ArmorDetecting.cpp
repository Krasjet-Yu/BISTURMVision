...
void* armorDetectingThread(void* PARAM)
{
    ...
    detector.loadSVM("/home/krasjet/Documents/RoboMaster/BISTURMVision/General/123svm.xml");

    //Set angle solver prop
    angleSolver.setCameraParam("/home/krasjet/Documents/RoboMaster/BISTURMVision/General/camera_params.xml", 1);
    ...
    {
        //FPS
        t = getTickCount(); //返回（retrieve）从操作系统启动到现在所经过（elapsed）的毫秒数
    ...
    #define DEBUG_MODE
        ...
        //					   1  2  3  4  5  6  7
        detector.showDebugInfo(0, 0, 1, 1, 0, 0, 0);
