...
using namespace cv;
using namespace std;
// z-axis: forward is positive+   backward is minus-
// x-axis: right is positive+     left is minus-
// y-axis: down is positive+      up is minus-
// opencv coordinate: original point is left_up point, x-axis is horizontal line, y-axis is perpendicular line
// but x-coordinate and y-coordinate is opposite to x-axis and y-axis
class AngleSolver
{
public:
    AngleSolver();
...
private:
    ...
    // Object points in word coordinate
