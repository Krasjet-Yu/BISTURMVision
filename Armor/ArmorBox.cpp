 ...
 * @Author: Krasjet_Yu
 * @Data:   2021/01/11
 * @Brief:  This cpp file define the ArmorBox class, realize some function used to judge whether armorbox or not
 ...
 */ 
const Point2f crossPointof(const Point2f& bl, const Point2f& tl, const Point2f& br, const Point2f& tr)
{
    float a1 = tr.y - bl.y;
    float b1 = tr.x - bl.x;
    float c1 = bl.x*tr.y - tr.y*bl.y;
